...
namespace Microsoft.Extensions.FileProviders.Physical
{
    ...
    public class PollingWildCardChangeToken : IChangeToken
    {
        ...
        private void ComputeHash(IncrementalHash sha256, string value, DateTime lastChangedUtc)
        {
            ...
            var length = Encoding.Unicode.GetBytes(value, 0, value.Length, _byteBuffer, 0);
